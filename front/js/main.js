...
document.getElementById("filtres").innerHTML = document.getElementById("filtres").innerHTML + "<div style='margin-bottom:2%;'>Map 1<input type='checkbox' id='map1' onclick='checkfiltres(1)' class='apple-switch' style='position:relative; float:right; margin-right:2%;'></div></br>"                      //affichage des différent filtres
document.getElementById("filtres").innerHTML = document.getElementById("filtres").innerHTML + "<div style='margin-bottom:2%;'>Map 2<input type='checkbox' id='map2' onclick='checkfiltres(2)' class='apple-switch' style='position:relative; float:right; margin-right:2%;'></div></br>" 
document.getElementById("filtres").innerHTML = document.getElementById("filtres").innerHTML + "<div style='margin-bottom:2%;'>Map 3<input type='checkbox' id='map3' onclick='checkfiltres(3)' class='apple-switch' style='position:relative; float:right; margin-right:2%;'></div></br>" 
